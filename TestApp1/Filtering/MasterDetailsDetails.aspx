<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="MasterDetailsDetails.aspx.cs" Inherits="Filtering_MasterDetailsDetails" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
        ...
        <asp:DropDownList ID="ProductsByCategory" runat="server" DataSourceID="ProductsByCategoryDataSource"
            DataTextField="ProductName" DataValueField="ProductID" AutoPostBack="True" OnDataBound="ProductsByCategory_DataBound" EnableViewState="False">
