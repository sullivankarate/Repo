...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
        ...
        <asp:DropDownList ID="Suppliers" runat="server" AppendDataBoundItems="True" AutoPostBack="True"
            DataSourceID="AllSuppliersDataSource" DataTextField="CompanyName" DataValueField="SupplierID" OnSelectedIndexChanged="Suppliers_SelectedIndexChanged">
    ...
    <p>
        <asp:GridView ID="ProductsBySupplier" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductID"
            DataSourceID="ProductsBySupplierDataSource" OnRowDataBound="ProductsBySupplier_RowDataBound">
            <Columns>
                <asp:CommandField ShowEditButton="True" />
