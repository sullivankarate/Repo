...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
        <asp:GridView ID="ProductsGrid" runat="server" AutoGenerateColumns="False" DataKeyNames="ProductID"
            DataSourceID="ProductsOptimisticConcurrencyDataSource" OnRowUpdated="ProductsGrid_RowUpdated">
            <Columns>
        ...
        <asp:ObjectDataSource ID="ProductsOptimisticConcurrencyDataSource" runat="server"
            ...
            SelectMethod="GetProducts" TypeName="ProductsOptimisticConcurrencyBLL" UpdateMethod="UpdateProduct" OnDeleted="ProductsOptimisticConcurrencyDataSource_Deleted" OnUpdated="ProductsOptimisticConcurrencyDataSource_Updated">
            <DeleteParameters>
