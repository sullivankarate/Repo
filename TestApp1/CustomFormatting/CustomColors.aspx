...
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <p>
        <asp:DetailsView ID="ExpensiveProductsPriceInBoldItalic" runat="server" AllowPaging="True" AutoGenerateRows="False" DataKeyNames="ProductID" DataSourceID="ObjectDataSource1" OnDataBound="ExpensiveProductsPriceInBoldItalic_DataBound" EnableViewState="False">
            <Fields>
