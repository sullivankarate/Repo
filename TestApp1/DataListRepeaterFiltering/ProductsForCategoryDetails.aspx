<%@ Page Language="C#" MasterPageFile="~/Site.master" AutoEventWireup="true" CodeFile="ProductsForCategoryDetails.aspx.cs" Inherits="DataListRepeaterFiltering_ProductsForCategoryDetails" Title="Untitled Page" %>
<asp:Content ID="Content1" ContentPlaceHolderID="MainContent" Runat="Server">
    ...
    <hr />
    <p>
        <asp:DataList ID="ProductsInCategory" runat="server" DataKeyField="ProductID" DataSourceID="ProductsInCategoryDataSource" RepeatColumns="2" EnableViewState="False" OnDataBinding="ProductsInCategory_DataBinding" OnItemDataBound="ProductsInCategory_ItemDataBound">
            <ItemTemplate>
